...
const FashionBEAUTYDETIALPAGE = ({route}) => {
          ...
          <View style={{   backgroundColor: 'rgb(199, 167, 112)', height: 2, flex: 1}} />
              ...
              <View>
                ...
                className="text-black my-3"
                  ...
                  {item.detial.descriptionTHREE.paramone}
                </Text>
                ...
                className="text-black opacity-90"
                  ...
                  {item.detial.descriptionTHREE.paramtwo}
                </Text>
                <Text
                className="text-black my-3"
                  style={{
                  ...
                  {item.detial.descriptionFOUR.paramone}
                </Text>
                ...
                className="text-black opacity-90"
                  ...
                  {item.detial.descriptionFOUR.paramtwo}
                </Text>
                <Text
                className="text-black my-3"
                  style={{
                  ...
                  {item.detial.descriptionFIVE.paramone}
                </Text>
                ...
                className="text-black opacity-90"
                  ...
                  {item.detial.descriptionFIVE.paramtwo}
                </Text>
              </View>
...
export default FashionBEAUTYDETIALPAGE;
